...
codes = [{"code":"BBV4.00","system":"readv2"},{"code":"BBV..00","system":"readv2"},{"code":"BBV3.00","system":"readv2"},{"code":"B30z000","system":"readv2"},{"code":"BBV..12","system":"readv2"},{"code":"BBV5.00","system":"readv2"},{"code":"BBV2.00","system":"readv2"}];
REQUIRED_CODES = 1;
